...
import type { SwfImportConformanceObservation } from '../swf/swf-import-conformance-worker-protocol.ts';
...
import { retainImportConformanceDiagnostic } from './import-conformance-diagnostic-evidence.ts';
