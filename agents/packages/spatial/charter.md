...
4. **3D backends.** BVH and octree for 3D broadphase, behind the **3D** seam (`SpatialIndexBackend3D`), not the 2D one. These serve `@flighthq/physics3d` and 3D scene culling, and the seam suffixing has to land before the first of them.
