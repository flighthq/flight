...
| `swf`              | display/movieclip · domain            | ✅ initial named-graph slice landed — standalone domain package; uncompressed root-timeline named instances + transforms + linkage into `Scene2DDocument`. Nested sprites, visual tags, and compression remain staged; ABC/execution out of scope |
