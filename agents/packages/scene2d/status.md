...
### New / Updated Functions (in @flighthq/scene2d)
...
All 195 tests pass. `npm run packages:check` ✓ · `npm run exports:check` ✓ (scene2d fully covered) · `npm run order:check` ✓ (no regressions in touched files).
