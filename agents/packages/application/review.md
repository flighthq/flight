...
- **Seams:** Loop scheduling and visibility are explicit Host traits with Web providers in `@flighthq/host-web`; `getWindowBackend`/`setWindowBackend`/`createWebWindowBackend` remains the window seam pending its own migration.
