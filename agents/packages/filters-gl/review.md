...
- **Package Map entry** — `agents/index.md` in the head tree carries a full `@flighthq/filters-gl` line documenting the leaf-shader-not-chain-applier boundary, the bounded kernels, and the out-of-scope chain dispatcher. ✓
