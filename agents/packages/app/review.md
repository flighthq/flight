...
- Rubric: `agents/packages/app/charter.md` (still a DRAFT stub — fell back to the codebase-map AAA + design-constraints standard where silent), `structural-forks.md`, `CONTRACT.md`, `index.md`.
