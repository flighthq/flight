...
- **Note the Map under-description.** _Cross-boundary._ The fix targets `agents/index.md` (the codebase map), which is outside the `packages/app/` + `agents/packages/app/` editable boundary.
