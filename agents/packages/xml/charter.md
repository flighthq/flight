...
> Durable vision and core values for `@flighthq/xml`. You author this (via an agent
...
XML parsing — turning XML text into a traversable document model (and, in an authoritative library, serializing back, streaming, and validating).
