...
215 functional scene IDs with committed baselines. Per-backend evidence:

| Evidence | Canvas | DOM | WebGL | WebGPU |
| --- | --- | --- | --- | --- |
| Realized + fingerprinted | 75 / 215 | 44 / 215 | 156 / 215 | 131 / 215 |
| Captured controls | 0 | 0 | 2 | 3 |
| Fingerprints total | 75 | 44 | 158 | 134 |
...
| Scene | Canvas | DOM | WebGL | WebGPU |
| --- | :-: | :-: | :-: | :-: |
| `instanced-mesh-batches` | · | · | · | · |
| `instanced-mesh-color` | · | · | · | · |
| `instanced-mesh-offscreen-origin` | · | · | · | · |
| `instanced-mesh-placement` | · | · | · | · |
| `instanced-mesh-rotated-normals` | · | · | · | · |
| `instanced-mesh-shadow` | · | · | · | · |
...
| `material-matcap` | · | · | ✓ | ✓ |
| `material-normal` | · | · | ✓ | ✓ |
| `material-pbr-extension-composition` | · | · | ✓ | · |
| `material-phong` | · | · | ✓ | ✓ |
| `material-sheen` | · | · | ✓ | · |
| `material-specular` | · | · | ✓ | · |
...
| `mesh-mirrored-facing` | · | · | · | · |
| `mesh-multiple-depth` | · | · | ✓ | ✓ |
| `mesh-normal-position-groups` | · | · | · | · |
| `mesh-plane` | · | · | ✓ | ✓ |
| `mesh-tangent-mirror-handedness` | · | · | ✓ | · |
