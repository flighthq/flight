...
import { glTilemapRenderer, registerGlStandardMaterial, renderGlScene2D } from '@flighthq/scene2d-gl';
...
const registry = {
  ...emptyRegistries,
  nodeRenderers: withRegistryTableEntry(emptyRegistries.nodeRenderers, TilemapKind, glTilemapRenderer),
};
