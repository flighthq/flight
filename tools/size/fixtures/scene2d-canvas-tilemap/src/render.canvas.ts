...
const registry = {
  ...emptyRegistries,
  nodeRenderers: withKindMapEntry(emptyRegistries.nodeRenderers, TilemapKind, canvasTilemapRenderer),
};
...
const state = createCanvasRenderState({ ...registry, canvasHost: webHostCanvas, pixelRatio: 1 });
