...
> **PRE-DIRECTION STUB.** This package was blessed during the image direction session (2026-07-02). No source exists yet. The breadth review at `tools/agents/docs/reviews/maturation/breadth/image-codec.md` has a detailed Bronze/Silver/Gold spec. Awaiting its own direction session.
