...
- **Open directions awaiting the user:** 507 across 102 charters — most-loaded: `scene` (13) · `displayobject-gl` (12) · `render-gl` (12) · `displayobject` (11) · `displayobject-dom` (10) · `effects-wgpu` (10) · `filters-css` (10) · `lighting` (10) · `scene-gl` (10) · `spritesheet-formats` (10) · `displayobject-canvas` (9) · `filters-canvas` (9) · `mesh` (9) · `render-wgpu` (9) · `displayobject-wgpu` (8) · `effects-gl` (8) · `filters-gl` (8) · `filters-surface` (8) · `geometry` (8) · `materials` (8) · `particles-formats` (8) · `scene-wgpu` (8) · `camera` (7) · `filters-wgpu` (7) · `render` (7) · `timeline` (7) · `effects-canvas` (6) · `filters` (6) · `image-codec` (6) · `loader` (6) · `tween` (6). Each charter's `## Open directions` section holds the questions; a direction session drains them.
