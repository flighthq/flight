...
- Conformance map (`tools/agents/docs/rust/conformance.md:66-67`) records both intentional divergences: `get_entity_runtime` asserting-vs-`Option`, and `get_entity_runtime_mut` as Rust-only. Both present exactly as the status claims.
