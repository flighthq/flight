...
| All 34 exported functions (`createSprite`, `computeTilemapLocalBoundsRectangle`, `hitTestQuadBatchPointXY`, `getQuadBatchTransformStride`, …) | matching `create_sprite`, `compute_tilemap_local_bounds_rectangle`, `hit_test_quad_batch_point_xy`, `get_quad_batch_transform_stride`, … | None — camelCase→snake_case, full type words preserved, no abbreviations, no renames. Conformance script: 34/34, 0 missing. |
