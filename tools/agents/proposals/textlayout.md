---
id: textlayout
title: '@flighthq/textlayout'
type: depth
target: textlayout
status: proposed
tier: bronze
source:
  - tools/agents/docs/reviews/maturation/depth/textlayout.md
  - tools/agents/docs/reviews/depth/textlayout.md
depends_on: []
updated: 2026-06-23
---
...
> Build `@flighthq/textlayout` up to the **Bronze** tier per the Scope + Design above (the package exists — extend it). Define any new shared types in `@flighthq/types` first. Follow the CLAUDE.md conventions. Satisfy every Acceptance checkbox. Surface cross-package or design decisions rather than guessing.
