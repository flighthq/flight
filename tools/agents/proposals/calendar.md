---
id: calendar
title: '@flighthq/calendar'
type: new-package
target: calendar
status: proposed
tier: bronze
source:
  - tools/agents/docs/reviews/maturation/breadth/calendar.md
...
Calendar and events integration — enumerate calendars, read/query/create/update/delete events and reminders (alarms), over a swappable host backend (web ICS/CalDAV-less default, native EventKit/Android-Calendar/Electron host, Rust crate).
