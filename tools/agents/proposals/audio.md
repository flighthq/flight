---
id: audio
title: '@flighthq/audio'
type: new-package
target: audio
status: proposed
tier: bronze
source:
  - tools/agents/docs/reviews/maturation/breadth/audio.md
...
An explicit audio mixer graph over `@flighthq/media`'s playback channels — gain/pan, buses/groups, ducking/crossfade, DSP effects, analyser/FFT spectrum, spatial/positional audio, generated and streaming `sampleData`, and microphone/audio input — the mature counterpart to media's thin playback channels.
