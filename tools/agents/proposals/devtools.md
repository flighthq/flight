---
id: devtools
title: '@flighthq/devtools'
type: new-package
target: devtools
status: proposed
tier: bronze
source:
  - tools/agents/docs/reviews/maturation/breadth/devtools.md
  - tools/agents/docs/reviews/breadth/missing-domains (gap #9 — "No debugging/devtools/profiling beyond `log`")..md
depends_on: []
updated: 2026-06-23
---
...
Opt-in developer tooling for a running Flight app — frame/timing stats, draw-call and triangle counters, scene-graph inspection, GPU timing, and a render overlay — exported for SDK consumers, not just internal CI.
