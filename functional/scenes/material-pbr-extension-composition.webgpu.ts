...
import { bakeWgpuEnvironmentIbl, drawWgpuScene3D } from '@flighthq/scene3d-wgpu';
import type { Bitmap, Camera3D, Environment, Node3D, Scene3DLights, VertexAttributeLayout } from '@flighthq/sdk';
import {
  ImageChannel,
  addNodeChild,
