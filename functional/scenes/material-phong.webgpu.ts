...
declareExpectedImageDescription(
  'An 800x600 field on a near-black background (0x0a0c10) with a single grey sphere centred at (400,300), about ' +
    ...
    'renders into an HDR rgba16f target and is tone-presented, so the highlight is a visible brightening over the ' +
    'surrounding lit cap rather than a hard white dot, and absolute levels are backend-dependent while the ' +
    'orderings (lit brighter than shadow, hotspot brighter than the lit cap around it) are not. The background ' +
    'stays near-black and is not lit.',
);
