...
declareExpectedImageDescription(
  'An 800x600 field of flat mid-grey covering the whole field edge to edge, with no shape visible as distinct ' +
    ...
    'darker than the underlying grey, at a fine scale rather than in large patches, and the variation is spread ' +
    'evenly across the whole field rather than clustering in one region. A perfectly uniform grey field with no ' +
    'speckle is the failure. The speckle is monochrome — it lightens and darkens without introducing colour — and ' +
