...
const pipeline = createWgpuEffectState(state, { sampleCount: 4, format: 'rgba16f' });
...
export function render(root: Node2D): void {
  ...
  endWgpuEffectState(scenePass, pipeline, [createBloomEffect({ threshold: 0.6, intensity: 1.4 })]);
