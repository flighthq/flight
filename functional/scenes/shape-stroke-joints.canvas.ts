// Canvas uses native lineJoin for this proof. The GPU siblings now tessellate the same miter/bevel/round
// outlines, and the DOM sibling uses CSS/SVG joins, so this scene has a column on all four backends.
//
