...
registerGlHalftoneEffect(state);
...
export function render(root: Node2D): void {
  ...
  endGlRenderEffectPipeline(state, pipeline, [createHalftoneEffect({ scale: 4, angle: 0.4 })]);
}
