...
// WebGPU leg of mesh-tangent-directional-seam.webgl.ts. The geometry and oracle are repeated so
// each functional backend stays self-contained while parity proves both consume the clustered frame.
