...
// begin/end (Lambert writes linear HDR into the rgba16f scene target, depth-tested), and
...
// sphere. No maps — the Wgpu backend does not sample maps, so a texture-free material keeps the
// Gl and Wgpu columns at parity.
