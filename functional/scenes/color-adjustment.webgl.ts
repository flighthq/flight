// color-adjustment — render-verifies the inline color-adjustment fold on WebGL, against a reference
...
// Opt into the inline color-adjustment fold on this Gl state; the tint is skipped otherwise.
