// color-adjustment — render-verifies the inline color-adjustment FOLD on WebGPU: a white sprite carrying a
...
// ColorTransform the fold consumes, and enableWgpuColorAdjustment installs the opt-in inline fold that turns
// the white source red. Without enableWgpuColorAdjustment the tint would be skipped (drawn white).
//
...
if (target.kind === 'webgpu') enableWgpuColorAdjustment(target.state);
