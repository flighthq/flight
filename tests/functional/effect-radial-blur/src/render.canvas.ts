...
// Canvas parity column. Radial blur is a documented PASSTHROUGH on Canvas 2D — the scene
...
registerCanvasRenderEffect(state, 'radialBlur', defaultCanvasRadialBlurEffectRunner);
