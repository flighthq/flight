...
// WebGPU parity column. The radial zoom smear is a color-only/uniform full-frame blur around the
...
registerWebGPURenderEffect(state, 'radialBlur', defaultWebGPURadialBlurEffectRunner);
