...
// WebGPU parity column for the same kuwahara intent as render.webgl.ts. WebGPU render-state init is
...
registerWebGPURenderEffect(state, 'kuwahara', defaultWebGPUKuwaharaEffectRunner);
...
export function render(root: DisplayObject): void {
  ...
  endWebGPURenderEffectPipeline(state, pipeline, [createKuwaharaEffect({ radius: 4 })]);
