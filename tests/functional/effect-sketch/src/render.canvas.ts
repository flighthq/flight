...
registerCanvasRenderEffect(state, 'SketchEffect', defaultCanvasSketchEffectRunner);
...
export function render(root: DisplayObject): void {
  ...
  endCanvasRenderEffectPipeline(state, pipeline, [createSketchEffect({ strength: 1 })]);
}
