...
//   - WebGL: the native median is a single-pass shader into an offscreen render target, composited onto
...
export interface ParityTarget {
  ...
  // Shader backends (WebGL): run the offscreen single-pass median and composite it at the native tile.
