...
import {
  ...
  defaultWebGPULookupTableGradeEffectRunner,
...
// WebGPU parity column for the same full-frame lutGrade grade as render.webgl.ts: applies a 32^3 lookup-table grade at full strength.
...
registerWebGPURenderEffect(state, 'lutGrade', defaultWebGPULookupTableGradeEffectRunner);
...
export function render(root: DisplayObject): void {
  ...
  endWebGPURenderEffectPipeline(state, pipeline, [createLookupTableGradeEffect({ size: 32, strength: 1 })]);
