...
// Canvas note: lutGrade is a documented Canvas passthrough — the Canvas 2D backend cannot express
...
export function render(root: DisplayObject): void {
  ...
  endCanvasRenderEffectPipeline(state, pipeline, [createLookupTableGradeEffect({ size: 32, strength: 1 })]);
}
