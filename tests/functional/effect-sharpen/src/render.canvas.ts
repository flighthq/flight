...
registerCanvasRenderEffect(state, 'SharpenEffect', defaultCanvasSharpenEffectRunner);
...
export function render(root: DisplayObject): void {
  ...
  endCanvasRenderEffectPipeline(state, pipeline, [createSharpenEffect({ amount: 1.5 })]);
}
