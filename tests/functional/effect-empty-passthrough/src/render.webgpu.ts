...
// WebGPU parity column for the empty-passthrough identity check. The scene renders through the effect
// pipeline with an EMPTY effect list at sampleCount 1; begin -> render -> end with no stages must
// present the scene unchanged, proving the WebGPU pipeline's present path is an identity blit.
