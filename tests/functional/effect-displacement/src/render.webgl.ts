...
registerWebGLRenderEffect(state, 'displacement', defaultWebGLDisplacementEffectRunner);
...
export function render(root: DisplayObject): void {
  ...
  endWebGLRenderEffectPipeline(state, pipeline, [createDisplacementEffect({ intensity: 10, frequency: 14, seed: 2 })]);
}
