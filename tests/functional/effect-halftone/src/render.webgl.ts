...
registerWebGLRenderEffect(state, 'halftone', defaultWebGLHalftoneEffectRunner);
...
export function render(root: DisplayObject): void {
  ...
  endWebGLRenderEffectPipeline(state, pipeline, [createHalftoneEffect({ scale: 4, angle: 0.4 })]);
}
