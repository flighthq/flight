...
registerWebGLRenderEffect(state, 'directionalBlur', defaultWebGLDirectionalBlurEffectRunner);
...
export function render(root: DisplayObject): void {
  ...
  endWebGLRenderEffectPipeline(state, pipeline, [createDirectionalBlurEffect({ angle: 0.5, length: 24, samples: 12 })]);
}
