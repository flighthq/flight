...
// WebGPU parity column. The directional smear is a color-only/uniform full-frame blur along the
...
registerWebGPURenderEffect(state, 'directionalBlur', defaultWebGPUDirectionalBlurEffectRunner);
