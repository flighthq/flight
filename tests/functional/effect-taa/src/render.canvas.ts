...
// Canvas taa: temporal and shader-driven, so this runner is a PASSTHROUGH on Canvas — the scene
// renders unchanged. Kept for backend parity.
...
registerCanvasRenderEffect(state, 'TaaEffect', defaultCanvasTaaEffectRunner);
