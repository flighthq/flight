...
// Canvas parity column. Glitch's per-pixel channel separation + hashed tears have no 2D draw-op path, so
...
registerCanvasRenderEffect(state, 'glitch', defaultCanvasGlitchEffectRunner);
