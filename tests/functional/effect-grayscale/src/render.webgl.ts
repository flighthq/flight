...
import {
  ...
  defaultWebGLGrayscaleEffectRunner,
...
registerWebGLRenderEffect(state, 'grayscale', defaultWebGLGrayscaleEffectRunner);
...
export function render(root: DisplayObject): void {
  ...
  endWebGLRenderEffectPipeline(state, pipeline, [createGrayscaleEffect({ intensity: 1 })]);
}
