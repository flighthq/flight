...
// WebGPU screenSpaceFog: depth-driven, but no depth buffer is bound here, so this is a color-only
...
registerWebGPURenderEffect(state, 'screenSpaceFog', defaultWebGPUScreenSpaceFogEffectRunner);
