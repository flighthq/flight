...
// Canvas screenSpaceFog: no depth buffer and no shader pipeline, so this runner is a color-only
// fallback / effectively PASSTHROUGH on Canvas. Kept for backend parity.
