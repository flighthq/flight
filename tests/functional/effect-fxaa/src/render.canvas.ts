...
// Canvas FXAA: Canvas 2D has no per-pixel edge-detect shader, so this runner is a PASSTHROUGH on
// Canvas — the scene renders unchanged. Kept for backend parity.
...
registerCanvasRenderEffect(state, 'FxaaEffect', defaultCanvasFxaaEffectRunner);
