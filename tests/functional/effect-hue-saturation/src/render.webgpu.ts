...
import {
  ...
  defaultWebGPUHueSaturationEffectRunner,
...
// WebGPU parity column for the same full-frame hueSaturation grade as render.webgl.ts: rotates hue 90 degrees and boosts saturation.
...
registerWebGPURenderEffect(state, 'hueSaturation', defaultWebGPUHueSaturationEffectRunner);
