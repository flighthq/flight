...
import {
  ...
  defaultWebGLPosterizeEffectRunner,
...
registerWebGLRenderEffect(state, 'posterize', defaultWebGLPosterizeEffectRunner);
...
export function render(root: DisplayObject): void {
  ...
  endWebGLRenderEffectPipeline(state, pipeline, [createPosterizeEffect({ levels: 4 })]);
}
