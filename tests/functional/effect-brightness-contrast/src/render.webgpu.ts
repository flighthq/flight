...
import {
  ...
  defaultWebGPUBrightnessContrastEffectRunner,
...
// WebGPU parity column for the same full-frame brightnessContrast grade as render.webgl.ts: lifts brightness and adds contrast across the whole frame.
...
registerWebGPURenderEffect(state, 'brightnessContrast', defaultWebGPUBrightnessContrastEffectRunner);
