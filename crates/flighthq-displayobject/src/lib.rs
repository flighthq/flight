...
pub use display_object::{
    ...
    get_display_object_local_content_revision, get_display_object_pivot_x,
    get_display_object_pivot_y, get_display_object_rotation, get_display_object_runtime,
    get_display_object_scale_x, get_display_object_scale_y, get_display_object_visible,
    get_display_object_x, get_display_object_y, invalidate_display_object_local_bounds,
    invalidate_display_object_local_content, is_display_object, prepare_display_object_render,
