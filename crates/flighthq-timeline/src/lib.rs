...
// timeline
pub use timeline::{
    TimelineFrame, create_timeline, create_timeline_source, find_timeline_label,
    goto_and_play_timeline, goto_and_stop_timeline, next_frame_timeline, play_timeline,
    prev_frame_timeline, stop_timeline, update_timeline,
};

// Re-export types used in the public API surface.
pub use flighthq_types::{
    MovieClipData, MovieClipSignals, Timeline, TimelineLabel, TimelineSource,
};
