//! `flighthq-world` — 3D world graph for spatial scene management.
//!
...
//! TypeScript `@flighthq/world` package.
//!
//! The world graph is a doorway for future development. The package currently
