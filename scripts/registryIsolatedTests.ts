...
export const REGISTRY_ISOLATED_TESTS: readonly RegistryIsolatedTest[] = [
  ...
  { path: 'packages/effects-gl/src/glColorLutPass.test.ts', reason: 'mocks-modules' },
  ...
  { path: 'packages/effects-gl/src/glDisplacementEffect.test.ts', reason: 'mocks-modules' },
  { path: 'packages/effects-gl/src/glDropShadowEffect.test.ts', reason: 'mocks-modules' },
  { path: 'packages/effects-gl/src/glEffectBlitShader.test.ts', reason: 'mocks-modules' },
  { path: 'packages/effects-gl/src/glEffectBoxBlur.test.ts', reason: 'mocks-modules' },
  { path: 'packages/effects-gl/src/glEffectProgramCache.test.ts', reason: 'mocks-modules' },
  ...
  { path: 'packages/effects-gl/src/glScanlinesEffect.test.ts', reason: 'mocks-modules' },
  ...
  { path: 'packages/effects-wgpu/src/wgpuBevelEffect.test.ts', reason: 'mocks-modules' },
  { path: 'packages/effects-wgpu/src/wgpuColorLutPass.test.ts', reason: 'mocks-modules' },
  ...
  { path: 'packages/effects-wgpu/src/wgpuGodRaysEffect.test.ts', reason: 'mocks-modules' },
  { path: 'packages/effects-wgpu/src/wgpuGradientBevelEffect.test.ts', reason: 'mocks-modules' },
  { path: 'packages/effects-wgpu/src/wgpuHalftoneEffect.test.ts', reason: 'mocks-modules' },
  ...
  { path: 'packages/effects-wgpu/src/wgpuLogicalEffectResolution.test.ts', reason: 'mocks-modules' },
  { path: 'packages/effects-wgpu/src/wgpuRadialBlurEffect.test.ts', reason: 'mocks-modules' },
