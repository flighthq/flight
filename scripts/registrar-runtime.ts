...
const MODULE_GLOBAL_REGISTRIES: readonly ModuleGlobalRegistryInventory[] = [
  ...
  {
    clear: instrumentSeam('clearWebImageBitmapComposers'),
    door: 'registerWebImageBitmapComposer',
    emptyAtImport: true,
    enumerate: callerSeam('getWebImageBitmapComposerKinds'),
    initialization: 'empty',
    module: '@flighthq/image-codec/contract',
    packageName: 'image-codec',
    population: 'caller-filled',
    read: callerSeam('getWebImageBitmapComposer'),
    ...
    unregister: weakIndependentSeam('unregisterWebImageBitmapComposer'),
  },
  {
...
function deriveDomProbeState(source: ReturnType<typeof createDomRenderState>) {
  ...
  derivedRuntime.registries = {
    ...
    nodeRenderers: derivedRuntime.registries.nodeRenderers,
