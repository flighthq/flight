// One-shot screenshot and log capture for examples or functional tests.
//
// Usage:
//   tsx ./scripts/capture.ts [options]
//
// Options:
//   --tool=explorer|functional   Which server to use (default: explorer)
...
//   --update-baseline            Write current screenshots as new baselines (tools/baselines/)
//   --fail-on-changed            Exit 1 if any screenshot differs from its baseline (for CI)
//
// Output per entry:
...
const tool = arg('tool', 'explorer') as 'explorer' | 'functional';
