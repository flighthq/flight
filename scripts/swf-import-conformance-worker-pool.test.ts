...
// This bounds starting two real worker threads and loading the complete SWF importer module graph while
// the broader suite runs in parallel. A timeout is a worker-startup/load-budget failure; assertion
// failures still identify importer or result-order regressions immediately.
const WORKER_POOL_TEST_TIMEOUT_MS = 15_000;
