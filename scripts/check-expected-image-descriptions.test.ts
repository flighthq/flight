...
describe('findExpectedImageDescriptionCellScope', () => {
  ...
  it('treats declareExpectedImageDescription as description-capable', () => {
    writeFileSync(
      ...
      'declareExpectedImageDescription("bloom halo"); beginGlEffectPass(state, pipeline);',
    );
...
describe('findScenesWithoutExpectedImageDescription', () => {
  ...
  it('rejects declareExpectedImageDescription with an empty string', () => {
    ...
    writeFileSync(
      ...
      'declareExpectedImageDescription(""); beginGlEffectPass(state, pipeline);',
    );
  ...
  it('accepts a concatenated declareExpectedImageDescription split across several operands', () => {
    ...
    writeFileSync(
      ...
      'declareExpectedImageDescription("a " + "bloom " + "halo"); beginGlEffectPass(state, pipeline);',
    );
...
describe('findScenesWithWithheldExpectedImageDescription', () => {
  ...
  it('lists a scene that withholds its description with a stated reason', () => {
    ...
    writeFileSync(
      ...
      'declareExpectedImageDescriptionWithheld("shader bug: sectors degenerate"); beginGlEffectPass(s, p);',
    );
  ...
  it('rejects a withheld declaration carrying no reason, counting it as missing instead', () => {
    ...
    writeFileSync(
      ...
      'declareExpectedImageDescriptionWithheld(""); beginGlEffectPass(s, p);',
    );
