...
describe('Point', () =>
{
    ...
    describe('add', () =>
    {
        ...
        it('writes the result to a target point if provided', () =>
        {
            pt.x = 2; pt.y = 10;
            pt2.x = 4; pt2.y = 20;
        ...
        it('works correctly if the target is one of the operands', () =>
        {
            pt.x = 3; pt.y = 7;
            pt2.x = 5; pt2.y = 10;
    ...
    describe('lerp', () =>
    {
        ...
        it('works correctly if the target is the first point', () =>
        {
            pt.x = 10; pt.y = 20;
            pt2.x = 30; pt2.y = 40;
        ...
        it('writes extrapolated lerp result to target', () =>
        {
            pt.x = 10; pt.y = 20;
            pt2.x = 30; pt2.y = 40;
    ...
    describe('polar', () =>
    {
        ...
        it('writes the result into a provided target point', () =>
        {
            ...
            expect(target.length).toBeCloseTo(5);
        });
    });
