...
export default class Matrix
{
    ...
    **/
    static createBox(target: Matrix, scaleX: number, scaleY: number, rotation: number = 0, tx: number = 0, ty: number = 0): void
    {
        // identity ();
        // rotate (rotation);
        // scale (scaleX, scaleY);
    ...
    **/
    static createGradientBox(target: Matrix, width: number, height: number, rotation: number = 0, tx: number = 0, ty: number = 0): void
    {
