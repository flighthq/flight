 ...
 */
export function add(a: Vector3D, b: Vector3D, target?: Vector3D): Vector3D
{
...
export function clone(source: Vector3D): Vector3D
{
 ...
 * The w component is ignored.
 */
export function copyFrom(target: Vector3D, source: Vector3D): void
{
    target.x = source.x;
    target.y = source.y;
    target.z = source.z;
 ...
 * If target is not specified, a new Vector3D is returned
**/
export function crossProduct(source: Vector3D, other: Vector3D, target?: Vector3D): Vector3D
{
    target = target ?? new Vector3D();
 ...
 * The w component is ignored.
**/
export function decrementBy(target: Vector3D, source: Vector3D): void
{
    target.x -= source.x;
    target.y -= source.y;
    target.z -= source.z;
...
export function equals(a: Vector3D, b: Vector3D, compareW: boolean = false): boolean
{
 ...
 * The w component is ignored.
**/
export function incrementBy(target: Vector3D, source: Vector3D): void
{
    target.x += source.x;
    target.y += source.y;
    target.z += source.z;
...
**/
export function nearEquals(a: Vector3D, b: Vector3D, tolerance: number, compareW: boolean = false): boolean
{
...
**/
export function negate(target: Vector3D): void
{
    target.x *= -1;
    target.y *= -1;
    target.z *= -1;
...
**/
export function normalize(target: Vector3D): number
{
...
**/
export function project(target: Vector3D): void
{
    target.x /= target.w;
    target.y /= target.w;
    target.z /= target.w;
 ...
 * The w component is ignored.
**/
export function scaleBy(target: Vector3D, scalar: number): void
{
    target.x *= scalar;
    target.y *= scalar;
    target.z *= scalar;
...
**/
export function setTo(target: Vector3D, x: number, y: number, z: number, w?: number): void
{
    target.x = x;
    target.y = y;
    target.z = z;
...
**/
export function subtract(source: Vector3D, other: Vector3D, target?: Vector3D): Vector3D
{
    target = target ?? new Vector3D();
