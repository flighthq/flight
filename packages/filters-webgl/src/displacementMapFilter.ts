...
const shaders = new WeakMap<WebGLRenderState, DisplacementMapShaderLocations>();
 ...
 * targets needed.
 */
export function applyDisplacementMapFilterToWebGL(
...
function getShader(state: WebGLRenderState): DisplacementMapShaderLocations {
