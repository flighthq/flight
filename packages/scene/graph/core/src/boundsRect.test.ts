...
function getRuntime<GraphKind extends symbol>(source: TestNode) {
  return getNodeRuntime(source) as GraphNodeRuntime<GraphKind, HasBoundsRect & HasTransform2D> & HasBoundsRectRuntime;
}
