...
export function initializeWebSoftKeyboardChangeBackend(
...
export function initializeWebSoftKeyboardInfoBackend(out: EntityConstruction<HostSoftKeyboardInfoCapability>): void {
