...
import type { EntityConstruction, HostShellExternalProvider } from '@flighthq/types/contract';

export function initializeWebShellExternalBackend(out: EntityConstruction<HostShellExternalProvider>): void {
  out.open = async (url) => {
