...
export const webHostPowerKeepAwake: Readonly<HostPowerKeepAwakeCapability> = Object.freeze({
  acquire: async (mode: PowerKeepAwakeMode): Promise<PowerKeepAwakeAcquireResult> => {
  ...
  release: async (): Promise<PowerKeepAwakeReleaseResult> => {
...
export const webHostPowerSuspension: Readonly<HostPowerSuspensionCapability> = Object.freeze({
...
export function createWebPowerReadings(): NonEntityCreateResult<WebPowerReadingCapabilities, 'descriptor'> {
  ...
  return Object.freeze({
    ...
    status: {
      getStatus: (statusOut: PowerStatus): PowerStatus => {
  ...
  } satisfies WebPowerReadingCapabilities);
}
