...
export function addSpringImpulse2D(spring2D: Spring2D, velocityX: number, velocityY: number): void {
  addSpringImpulse(spring2D.x, velocityX);
  addSpringImpulse(spring2D.y, velocityY);
}
