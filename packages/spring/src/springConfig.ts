...
// Builds a `SpringConfig` from the designer-intuitive `frequency` (Hz) and `dampingRatio`
...
// Builds a `SpringConfig` from a physical spring: `stiffness` (k), `damping` (c), and `mass` (m).
