...
const lookupPipelines = new WeakMap<WebGPURenderState, WebGPUFilterPipeline>();

function getLookupPipeline(state: WebGPURenderState): WebGPUFilterPipeline {
 ...
 */
export function applyGradientGlowFilterToWebGPU(
