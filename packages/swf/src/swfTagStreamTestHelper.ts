...
export function createSwf(tags: ReadonlyArray<Uint8Array>): Uint8Array {
...
export function joinBytes(...parts: ReadonlyArray<Uint8Array>): Uint8Array {
  let length = 0;
...
export function signedBitCount(values: ReadonlyArray<number>): number {
