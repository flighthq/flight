...
export const swfSoundTagFamily: SwfTagFamily = {
  instantiate: {
...
// One block of an interleaved MP3 stream, minus the per-block sample header the format prefixes it with.
// A stream in any other format is declined whole rather than partially concatenated.
