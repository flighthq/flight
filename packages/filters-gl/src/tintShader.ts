 ...
 */
export function applyGlBlitOffsetPass(
  state: GlRenderState,
...
export function applyGlBlitPass(state: GlRenderState, source: GlRenderTarget, dest: GlRenderTarget): void {
...
export function applyGlInvertTintPass(
  state: GlRenderState,
  source: GlRenderTarget,
  dest: GlRenderTarget,
  color: number,
...
export function applyGlTintPass(
  state: GlRenderState,
  source: GlRenderTarget,
  dest: GlRenderTarget,
  color: number,
...
export function getGlBlitOffsetShader(state: GlRenderState): BlitOffsetShaderLocations {
...
export function getGlBlitShader(state: GlRenderState): GlFullscreenProgram {
...
export function getGlInvertTintShader(state: GlRenderState): TintShaderLocations {
...
export function getGlTintShader(state: GlRenderState): TintShaderLocations {
