...
import type { CanvasRenderSurface, TextFormat, TextMeasureFunction } from '@flighthq/types/contract';
...
export function createCanvasTextMeasure(surface: Readonly<CanvasRenderSurface>): TextMeasureFunction {
