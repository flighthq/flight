...
// the adjustments colorMatrixMath convention: linear RGBA coefficients + normalized-linear bias column) and
...
// Slot layout: [0..3]=row R, [4..7]=row G, [8..11]=row B, [12..15]=row A, [16..19]=bias column.
