...
export const wgpuNode2DVelocityWriter: WgpuVelocityWriter = (ctx, node) => {
...
export const wgpuParticleEmitter2DVelocityWriter: WgpuVelocityWriter = (ctx, node) => {
...
// Node2D writer. Identical math to glQuadBatchVelocityWriter.
export const wgpuQuadBatchVelocityWriter: WgpuVelocityWriter = (ctx, node) => {
