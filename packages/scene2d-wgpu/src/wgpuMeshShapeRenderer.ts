...
export function drawWgpuMeshShape(state: WgpuRenderState, renderProxy: RenderProxy2D): boolean {
  ...
  const tessellatorEntry = runtime.registries.strokeTessellator;
...
// never references the canvas replay — so registering this renderer instead of wgpuShapeRenderer
...
export const wgpuMeshShapeRenderer: Scene2DRenderer = {
