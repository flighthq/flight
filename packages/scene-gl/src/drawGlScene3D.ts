...
import { getNode3DWorldAlpha } from '@flighthq/scene';
import type {
  Camera3D,
...
export function drawGlScene3D(
  ...
  // prepareScene3DRender (prepareScene3DMorph in @flighthq/scene, prepareScene3DSkinning in @flighthq/skeleton3d)
