...
describe('updateCamera2DFollow', () => {
  it('does not move when the target is inside the deadzone', () => {
    ...
    updateCamera2DFollow(camera, 800, 600, 50, 30, 0.016, { deadzoneHalfWidth: 100, deadzoneHalfHeight: 100 });
  ...
  it('moves partway toward the target with smoothing over one step', () => {
    const camera = createCamera2D();
    updateCamera2DFollow(camera, 800, 600, 100, 0, 0.016, { smoothTime: 0.1 });
  ...
  it('snaps the target onto the deadzone edge when smoothTime is 0', () => {
    const camera = createCamera2D();
    updateCamera2DFollow(camera, 800, 600, 300, 0, 0.016, { deadzoneHalfWidth: 100, smoothTime: 0 });
  ...
  it('clamps the camera so the visible bounds stay inside world bounds', () => {
    ...
    updateCamera2DFollow(camera, 800, 600, 1900, 1000, 0.016, { smoothTime: 0, worldBounds });
    ...
    getCamera2DVisibleBounds(camera, 800, 600, visible);
