...
import type { DisplayObject, DOMStageRectangle, RenderNode2D } from '@flighthq/types';

import { createDOMStageRectangle } from './domClipRectangle';

export function pushDOMMaskRectangle(rectangles: DOMStageRectangle[], data: RenderNode2D): void {
