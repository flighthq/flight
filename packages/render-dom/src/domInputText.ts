...
export function drawDOMInputText(state: DOMRenderState, renderNode: DisplayObjectRenderTreeNode): void {
  ...
  const selColor = rgbaToHexString(source.data.selectionColor);
