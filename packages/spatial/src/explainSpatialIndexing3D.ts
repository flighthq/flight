import type { SpatialIndex3D, SpatialIndexingExplanation, SpatialObjectId } from '@flighthq/types/contract';
...
// removed, so a test can pin it without timing anything. It matters more here than in 2D — the span
// a missing bound would walk grows with the cube of an object's extent rather than the square.
export function explainSpatialIndexing3D(
