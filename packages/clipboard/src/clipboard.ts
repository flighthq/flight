...
export function clearClipboard(hostClipboardText: Readonly<HostClipboardTextCapability>): Promise<boolean> {
...
export function getClipboardFormats(
  hostClipboardFormats: Readonly<HostClipboardFormatsCapability>,
...
export async function hasClipboardBookmark(
  hostClipboardBookmark: Readonly<HostClipboardBookmarkCapability>,
): Promise<boolean> {
...
export function hasClipboardHtml(hostClipboardFormats: Readonly<HostClipboardFormatsCapability>): Promise<boolean> {
...
export function hasClipboardImage(hostClipboardImage: Readonly<HostClipboardImageCapability>): Promise<boolean> {
...
export function hasClipboardRTF(hostClipboardFormats: Readonly<HostClipboardFormatsCapability>): Promise<boolean> {
...
export function hasClipboardText(hostClipboardText: Readonly<HostClipboardTextCapability>): Promise<boolean> {
...
export function readClipboardHtml(hostClipboardFormats: Readonly<HostClipboardFormatsCapability>): Promise<string> {
...
export function readClipboardImage(hostClipboardImage: Readonly<HostClipboardImageCapability>): Promise<string> {
  return hostClipboardImage.readImage();
}

// Reads RTF markup from the clipboard, or '' when none is present or access is denied.
export function readClipboardRTF(hostClipboardFormats: Readonly<HostClipboardFormatsCapability>): Promise<string> {
  return hostClipboardFormats.readRTF();
}

// Reads plain text from the clipboard, or '' when empty or access is denied.
export function readClipboardText(hostClipboardText: Readonly<HostClipboardTextCapability>): Promise<string> {
...
export function writeClipboardImage(
  hostClipboardImage: Readonly<HostClipboardImageCapability>,
  dataUrl: string,
): Promise<boolean> {
...
export function writeClipboardText(
  hostClipboardText: Readonly<HostClipboardTextCapability>,
  text: string,
): Promise<boolean> {
