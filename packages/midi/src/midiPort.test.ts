...
describe('initializeMidiInputPortResource', () => {
  it('is the construction initializer of createMidiInputPortResource', () => {
    expect(typeof initializeMidiInputPortResource).toBe('function');
  });
});

describe('initializeMidiOutputPortResource', () => {
  it('is the construction initializer of createMidiOutputPortResource', () => {
    expect(typeof initializeMidiOutputPortResource).toBe('function');
  });
});
