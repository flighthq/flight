import type { GraphNode, MethodsOf, PartialNode, Rectangle, Text, TextData, TextRuntime } from '@flighthq/types';
...
export function computeTextLocalBoundsRectangle(out: Rectangle, source: Readonly<GraphNode>): void {
