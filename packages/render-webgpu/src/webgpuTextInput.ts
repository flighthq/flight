...
// Installs the caret/selection overlay onto the WebGPU RichText renderer. Importing this opts an app into
// text-input rendering; a static RichText leaves the slot null and pulls none of this module.
export function enableWebGPUTextInput(): void {
  registerWebGPUTextInputOverlay(drawWebGPUTextInputOverlay);
}
