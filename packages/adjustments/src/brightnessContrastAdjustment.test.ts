...
describe('initializeBrightnessContrastAdjustment', () => {
  it('is the construction initializer of createBrightnessContrastAdjustment', () => {
    expect(typeof initializeBrightnessContrastAdjustment).toBe('function');
  });
});
