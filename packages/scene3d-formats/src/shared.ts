...
// parser carries the bytes but does not decode them — @flighthq/scene3d-resources decodes on resolve.
...
// a fresh Texture. The parser references the image, it does not load or decode it — @flighthq/scene3d-
