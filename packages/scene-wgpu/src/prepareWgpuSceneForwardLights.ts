...
// WebGPU twin of prepareGlSceneForwardLights: rank point and spot lights at each visible mesh's
...
export function prepareWgpuSceneForwardLights(
...
function createLightBlock(): SceneLightBlock {
  return {
    ambientCount: 0,
...
interface Prepared {
  ...
  list: WgpuSceneForwardLightList;
