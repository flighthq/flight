...
import { createNode3D, Node3DKind } from '@flighthq/scene';
import type { Camera3D, ParticleEmitter3D, Scene3DLightsLike } from '@flighthq/types';
...
function makeLights(): Scene3DLightsLike {
...
describe('drawWgpuScene3DParticleEmitter3Ds', () => {
