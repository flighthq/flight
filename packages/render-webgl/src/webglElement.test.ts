import { createWebGLElement } from './webglElement';

describe('createWebGLElement', () => {
  it('returns an HTMLCanvasElement', () => {
    const canvas = createWebGLElement(100, 200);
  ...
  it('scales pixel dimensions by pixelRatio', () => {
    const canvas = createWebGLElement(100, 200, 2);
  ...
  it('keeps CSS dimensions unchanged regardless of pixelRatio', () => {
    const canvas = createWebGLElement(300, 150, 3);
