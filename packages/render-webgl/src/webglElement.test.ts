import { createWebGLCanvasElement } from './webglElement';

describe('createWebGLCanvasElement', () => {
  it('returns an HTMLCanvasElement', () => {
    const canvas = createWebGLCanvasElement(100, 200);
  ...
  it('scales pixel dimensions by pixelRatio', () => {
    const canvas = createWebGLCanvasElement(100, 200, 2);
  ...
  it('keeps CSS dimensions unchanged regardless of pixelRatio', () => {
    const canvas = createWebGLCanvasElement(300, 150, 3);
