...
// Nine of these faces were wound the opposite way from the other twenty-seven, which put their
// geometric face normals against the outward vertex normals the builder authors. Only those nine
// are reversed; the winding here is per-face data, not a convention the whole table shares.
