...
// StandardPbrMaterialKind) — the WGSL mirror of glStandardPbrMeshMaterialRenderer. bind selects the
...
export const wgpuStandardPbrMeshMaterialRenderer: WgpuMeshMaterialRenderer = {
  bind(
    state: WgpuRenderState,
