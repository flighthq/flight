...
// mirror of glUnlitMeshMaterialRenderer. Lighting-independent flat color: bind selects the unlit
...
export const wgpuUnlitMeshMaterialRenderer: WgpuMeshMaterialRenderer = {
  bind(
...
export function registerWgpuUnlitMaterial(state: WgpuRenderState): void {
  ...
  registerWgpuMeshMaterialRenderer(state, UnlitMaterialKind, wgpuUnlitMeshMaterialRenderer);
}
