...
export const wgpuToonMeshMaterialRenderer: WgpuMeshMaterialRenderer = {
  bind(
...
export function registerWgpuToonMaterial(state: WgpuRenderState): void {
  ...
  registerWgpuMeshMaterialRenderer(state, ToonMaterialKind, wgpuToonMeshMaterialRenderer);
}
