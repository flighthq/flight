...
export const wgpuCustomShaderMeshMaterialRenderer: WgpuMeshMaterialRenderer = {
  bind(
...
export function registerWgpuCustomShaderMaterial(state: WgpuRenderState): void {
  ...
  registerWgpuMeshMaterialRenderer(state, CustomShaderMaterialKind, wgpuCustomShaderMeshMaterialRenderer);
}
