...
export const wgpuVertexColorMeshMaterialRenderer: WgpuMeshMaterialRenderer = {
  bind(
...
export function registerWgpuVertexColorMaterial(state: WgpuRenderState): void {
  registerWgpuMeshMaterialRenderer(state, VertexColorMaterialKind, wgpuVertexColorMeshMaterialRenderer);
}
