...
export const wgpuDepthMeshMaterialRenderer: WgpuMeshMaterialRenderer = {
  bind(
...
export function registerWgpuDepthMaterial(state: WgpuRenderState): void {
  registerWgpuMeshMaterialRenderer(state, DepthMaterialKind, wgpuDepthMeshMaterialRenderer);
}
