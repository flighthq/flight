...
export const wgpuNormalMeshMaterialRenderer: WgpuMeshMaterialRenderer = {
  bind(
...
export function registerWgpuNormalMaterial(state: WgpuRenderState): void {
  ...
  registerWgpuMeshMaterialRenderer(state, NormalMaterialKind, wgpuNormalMeshMaterialRenderer);
}
