...
export const wgpuMatcapMeshMaterialRenderer: WgpuMeshMaterialRenderer = {
  bind(
...
export function registerWgpuMatcapMaterial(state: WgpuRenderState): void {
  ...
  registerWgpuMeshMaterialRenderer(state, MatcapMaterialKind, wgpuMatcapMeshMaterialRenderer);
}
