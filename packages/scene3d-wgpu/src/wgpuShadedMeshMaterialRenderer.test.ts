...
describe('registerWgpuShadedMaterial', () => {
  it('installs the renderer for ShadedMaterialKind', () => {
    ...
    expect(getWgpuMeshMaterialRenderer(state, ShadedMaterialKind)).toBe(wgpuShadedMeshMaterialRenderer);
  });
});

describe('wgpuShadedMeshMaterialRenderer', () => {
  it('bind compiles a shaded module and binds frame, material, and sample groups', () => {
    ...
    wgpuShadedMeshMaterialRenderer.bind(state, createShadedMaterial(), LIGHTS, camera);
