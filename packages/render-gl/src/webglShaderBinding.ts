...
import type { DisplayObject, GlRenderState, RenderProxy2D } from '@flighthq/types';
...
export function getGlMaterialShader(state: GlRenderState, kind: symbol): GlBitmapShader | null {
...
export function registerGlMaterialShader(state: GlRenderState, kind: symbol, shader: GlBitmapShader): void {
