import type { HostAccessibilityCapability, AccessibilityNode } from '@flighthq/types/contract';
...
function createProvider(overrides: Partial<HostAccessibilityCapability> = {}): HostAccessibilityCapability {
  return {
