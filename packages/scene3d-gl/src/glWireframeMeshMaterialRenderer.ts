...
export const glWireframeMeshMaterialRenderer: GlMeshMaterialRenderer = {
  bind(
    state: GlRenderState,
...
export function registerGlWireframeMaterial(state: GlRenderState): void {
  registerGlMeshMaterialRenderer(state, WireframeMaterialKind, glWireframeMeshMaterialRenderer);
}
