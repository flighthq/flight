...
// analog of getGlQuadMaterialRenderer; reads scene-gl's own per-state persistent registry table,
...
// registerGlStandardPbrMaterial for the built-in StandardPbr path. Mirrors registerGlQuadMaterialRenderer
...
// through registration). Mirrors resolveGlQuadMaterialRenderer over the 3D registry.
