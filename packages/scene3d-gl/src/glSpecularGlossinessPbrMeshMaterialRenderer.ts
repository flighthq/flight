...
export const glSpecularGlossinessPbrMeshMaterialRenderer: GlMeshMaterialRenderer = {
  bind(
    state: GlRenderState,
...
export function registerGlSpecularGlossinessPbrMaterial(state: GlRenderState): void {
  registerGlMeshMaterialRenderer(state, SpecularGlossinessPbrMaterialKind, glSpecularGlossinessPbrMeshMaterialRenderer);
}
