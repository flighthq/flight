...
export const glBlinnPhongMeshMaterialRenderer: GlMeshMaterialRenderer = {
  bind(
    state: GlRenderState,
...
export function registerGlBlinnPhongMaterial(state: GlRenderState): void {
  registerGlMeshMaterialRenderer(state, BlinnPhongMaterialKind, glBlinnPhongMeshMaterialRenderer);
}
