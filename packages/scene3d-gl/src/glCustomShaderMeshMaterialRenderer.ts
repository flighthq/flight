...
export const glCustomShaderMeshMaterialRenderer: GlMeshMaterialRenderer = {
  bind(
    state: GlRenderState,
...
export function registerGlCustomShaderMaterial(state: GlRenderState): void {
  registerGlMeshMaterialRenderer(state, CustomShaderMaterialKind, glCustomShaderMeshMaterialRenderer);
}
