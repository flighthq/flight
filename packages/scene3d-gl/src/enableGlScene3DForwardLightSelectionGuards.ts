...
// Installs the shakeable forward-light selection guard on `state`. renderGlScene3D reaches this guard
...
function warnGlScene3DForwardLightSelectionRequired(lights: Readonly<Scene3DLightsLike>): void {
  logOnce(
    ...
    {
      message:
        'renderGlScene3D: punctual lights exceed MAX_FORWARD_LIGHTS and will be input-order truncated — call prepareGlScene3DForwardLights after prepareScene3DRender and pass its result to renderGlScene3D.',
