...
export const glVertexColorMeshMaterialRenderer: GlMeshMaterialRenderer = {
  bind(
    state: GlRenderState,
...
export function registerGlVertexColorMaterial(state: GlRenderState): void {
  registerGlMeshMaterialRenderer(state, VertexColorMaterialKind, glVertexColorMeshMaterialRenderer);
}
