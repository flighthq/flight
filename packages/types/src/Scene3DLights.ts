...
// hemisphere lights. prepareScene3DRender resolves this into the packed Scene3DLightBlock (sRgb->linear
...
// Structural input accepted by light packing/draw operations. The createScene3DLights product itself is
