...
// render state via registerCanvasMaterialRenderer. Unlike the WebGL renderer, this is
...
//
// The deliberate WebGL/Canvas asymmetry — imperative bind() versus declarative getState() —
