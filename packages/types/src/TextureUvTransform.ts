...
// The KHR_texture_transform fields shared by every uv-carrying Texture backing. `uvOffset`/`uvScale`
...
// accept, so every backing routes through one uv-transform path.
//
