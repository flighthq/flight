...
// tints it from any registered backing: still image, live video host handle, or produced render
// target. The backend resolver decides whether to upload CPU-origin pixels or return a GPU-origin
