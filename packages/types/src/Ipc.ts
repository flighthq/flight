...
export interface HostIpcHandleProvider extends Entity {
  handle(channel: string, handler: (...args: readonly unknown[]) => unknown | Promise<unknown>): () => void;
}

export interface HostIpcInvokeProvider extends Entity {
  invoke(channel: string, args: readonly unknown[]): Promise<unknown>;
}

export interface HostIpcMessageProvider extends Entity {
...
export interface HostIpcSendProvider extends Entity {
...
export interface HostIpcTargetedSendProvider<Target = never> extends Entity {
