...
// `references` is its enumerable content contract. Applications fill references only through the
// scene2d-resources resolve/load APIs; targets are retained here so codecs can bind each manifest entry
// without a parallel path language or hidden runtime.
