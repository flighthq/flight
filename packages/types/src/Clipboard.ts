...
export interface HostClipboardBookmarkCapability {
...
export interface HostClipboardFormatsCapability {
...
export interface HostClipboardImageCapability {
...
export interface HostClipboardTextCapability {
