...
export interface HostConnectivityStatusCapability extends Entity {
  getStatus(out: ConnectivityStatus): ConnectivityStatus;
}

export interface HostConnectivityChangeCapability extends Entity {
...
export interface HostConnectivityReachabilityCapability extends Entity {
  detectReachability(
