...
// with `createTintAdjustment` / `setNodeColorAdjustmentsTint`. It supersedes the retired
// ColorScaleBiasAdjustment: no parallel 8-float payload, only the fused matrix the resolver reads.
