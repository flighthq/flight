...
import type { WgpuMaterialRenderer } from './WebGPUMaterialRenderer';
...
export interface WgpuRenderStateRuntime extends RenderStateRuntime {
  ...
  materialRendererMap?: Map<symbol, WgpuMaterialRenderer>;
  ...
  sceneMeshMaterialRegistry?: Map<symbol, WgpuMeshMaterialRenderer> | null;
