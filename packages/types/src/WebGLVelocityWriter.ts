...
// WebGLVelocityWriter is registered per renderable Kind (registerWebGLVelocityWriter) and draws that
...
export interface WebGLVelocityContext {
...
export type WebGLVelocityWriter = (ctx: Readonly<WebGLVelocityContext>, node: object) => void;
