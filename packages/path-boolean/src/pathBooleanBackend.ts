...
export function getPathBooleanBackend(): HostPathBooleanProvider {
...
export function setPathBooleanBackend(backend: HostPathBooleanProvider | null): void {
  _backend = backend;
}
...
let _backend: HostPathBooleanProvider | null = null;
