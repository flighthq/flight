...
describe('buildWgpuScale9Mapper', () => {
  it('returns null for invalid scale or bounds', () => {
    expect(buildWgpuScale9Mapper(createRectangle(0, 0, 0, 100), createRectangle(10, 10, 20, 20), 1, 1)).toBeNull();
    expect(buildWgpuScale9Mapper(createRectangle(0, 0, 100, 100), createRectangle(10, 10, 20, 20), 0, 1)).toBeNull();
  });

  it('maps edge and center coordinates using 9-slice scaling', () => {
    const mapper = buildWgpuScale9Mapper(createRectangle(0, 0, 100, 100), createRectangle(10, 10, 20, 20), 2, 3)!;
