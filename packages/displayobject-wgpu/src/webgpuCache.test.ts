...
import type * as WgpuDisplayObjectModule from './webgpuDisplayObject';
import { renderWgpuDisplayObject } from './webgpuDisplayObject';
import type * as WgpuSpriteBatchModule from './webgpuSpriteBatch';
