...
// is an exact copy of the Gl mapper — the math is renderer-agnostic and is duplicated per backend
// to keep each render package self-contained; a shared home (e.g. displayobject-canvas, which already owns
// mapCanvasScale9ShapeCommands) would let both backends drop their copy.
export function buildWgpuScale9Mapper(
