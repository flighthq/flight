 ...
 */
export function blurBitmapPixelsHorizontal(
 ...
 */
export function blurBitmapPixelsHorizontalWeighted(
  out: Uint8ClampedArray,
  source: Readonly<Uint8ClampedArray>,
  width: number,
  height: number,
 ...
 * `out` must not alias `source`.
 */
export function blurBitmapPixelsVertical(
  out: Uint8ClampedArray,
  source: Readonly<Uint8ClampedArray>,
  width: number,
  height: number,
 ...
 * `source`, writes to `out`. `out` must not alias `source`.
 */
export function blurBitmapPixelsVerticalWeighted(
  out: Uint8ClampedArray,
  source: Readonly<Uint8ClampedArray>,
  width: number,
  height: number,
 ...
 * full bitmap.
 */
export function boxBlurBitmap(
  out: Uint8ClampedArray,
  scratch: Uint8ClampedArray,
  source: Readonly<BitmapRegion>,
  options: Readonly<BitmapBoxBlurOptions> = {},
): void {
  ...
  extractBitmapPixels(out, source);
  ...
  for (let pass = 0; pass < passes; pass++) {
    if (radiusX > 0) {
      blurBitmapPixelsHorizontal(b, a, source.width, source.height, radiusX);
      const t = a;
      a = b;
      b = t;
    }
    if (radiusY > 0) {
      blurBitmapPixelsVertical(b, a, source.width, source.height, radiusY);
      const t = a;
      a = b;
      b = t;
    }
 ...
 * full bitmap.
 */
export function gaussianBlurBitmap(
  out: Uint8ClampedArray,
  scratch: Uint8ClampedArray,
  source: Readonly<BitmapRegion>,
  sigmaX: number,
  ...
  for (let pass = 0; pass < passCount; pass++) {
    if (kernelX) {
      blurBitmapPixelsHorizontalWeighted(b, a, source.width, source.height, kernelX);
      const t = a;
      a = b;
      b = t;
    }
    if (kernelY) {
      blurBitmapPixelsVerticalWeighted(b, a, source.width, source.height, kernelY);
      const t = a;
      a = b;
      b = t;
    }
