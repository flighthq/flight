...
import type * as GlinnergloweffectModule from './glInnerGlowEffect';
...
let applyInnerGlowEffectToGl: typeof GlinnergloweffectModule.applyInnerGlowEffectToGl;
let defaultGlInnerGlowEffectRunner: typeof GlinnergloweffectModule.defaultGlInnerGlowEffectRunner;
...
beforeAll(async () => {
  ...
  ({ applyInnerGlowEffectToGl, defaultGlInnerGlowEffectRunner } = await import('./glInnerGlowEffect'));
});
